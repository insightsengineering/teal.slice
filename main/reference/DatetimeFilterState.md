...
#> is.na(x) | x >= as.POSIXct("2026-07-02 22:43:22", tz = "Etc/UTC") & 
#>     x < as.POSIXct("2026-07-03 07:43:23", tz = "Etc/UTC")
...
isolate(filter_state$get_call())
#> is.na(x) | x >= as.POSIXct("2026-07-02 22:43:25.376766", tz = "Etc/UTC") & 
#>     x < as.POSIXct("2026-07-02 22:43:31.376806", tz = "Etc/UTC")
