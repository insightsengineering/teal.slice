test_that("check_simple_name behaves as expected", {
  ...
  testthat::expect_error(check_simple_name("1a"))
  testthat::expect_error(check_simple_name("ADSL.modified"))
  testthat::expect_error(check_simple_name("a1..."))
  testthat::expect_error(check_simple_name("a a"))
  testthat::expect_error(check_simple_name("_A_b"))
})
