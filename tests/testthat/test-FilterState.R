...
testthat::test_that("constructor checks arguments", {
  ...
  testthat::expect_error(
    FilterState$new(x = 7, slice = filter_var(dataname = "data", varname = "var"), x_reactive = NULL),
  ...
  testthat::expect_error(
    FilterState$new(x = 7, slice = filter_var(dataname = "data", varname = "variable"), extract_type = "other"),
...
testthat::test_that("set_state can set mutable fields", {
  filter_state <- FilterState$new(x = 7, slice = filter_var(dataname = "data", varname = "var"))
...
testthat::test_that("set_state only sets properties defined in `teal_slice", {
  filter_state <- FilterState$new(x = 7, slice = filter_var(dataname = "data", varname = "var"))
  filter_state$set_state(filter_var(dataname = "data", varname = "var", selected = 7))
  testthat::expect_identical(
    shiny::isolate(filter_state$get_state()$selected),
    7
  )
  filter_state$set_state(filter_var(dataname = "data", varname = "var", keep_na = FALSE))
  testthat::expect_false(shiny::isolate(filter_state$get_state()$keep_na))
  filter_state$set_state(filter_var(dataname = "data", varname = "var", keep_inf = FALSE))
...
testthat::test_that("set_state cannot set mutable fields in a fixed FilterState", {
  filter_state <- FilterState$new(
    x = c("a", NA_character_),
    slice = filter_var(dataname = "data", varname = "var", fixed = TRUE)
  )
...
testthat::test_that("set_state can set mutable fields in a locked FilterState", {
  filter_state <- FilterState$new(
    x = c("a", NA_character_),
    slice = filter_var(dataname = "data", varname = "variable", locked = TRUE)
  )
  old_state <- shiny::isolate(filter_state$get_state())
  new_state <- filter_var(
    dataname = "data",
...
testthat::test_that("constructor initializes selected = NULL by default", {
  filter_state <- FilterState$new(7, slice = filter_var(dataname = "data", varname = "var"))
...
testthat::test_that("constructor initializes keep_na = TRUE by default if data contains NAs", {
  ...
  filter_state <- FilterState$new(c(7, NA), slice = filter_var(dataname = "data", varname = "var"))
...
testthat::test_that("set_selected sets value, get_selected returns the same value", {
  ...
  filter_state <- test_class$new(7L, slice = filter_var(dataname = "data", varname = "var"))
  selection <- 7
...
testthat::test_that("add_keep_na_call modifies call if keep_na set to TRUE", {
  ...
  filter_state <- test_class$new(c(1, NA), slice = filter_var(dataname = "data", varname = "var", keep_na = FALSE))
  testthat::expect_identical(
...
testthat::test_that("setting private$na_rm to TRUE adds `!is.na` before condition via add_keep_na_call", {
  ...
  filter_state <- test_class$new(c(1, NA), slice = filter_var(dataname = "data", varname = "variable", keep_na = FALSE))
...
testthat::test_that(
  ...
  via add_keep_na_call when variable has no NAs",
  {
    ...
    filter_state <- test_class$new(c(1), slice = filter_var(dataname = "data", varname = "variable", keep_na = FALSE))
    filter_state$set_na_rm(TRUE)
...
testthat::test_that("get_varlabel returns a string if x has the label attribute different to varname", {
  ...
  seven <- c(7)
  filter_state <- test_class$new(seven, slice = filter_var(dataname = "data", varname = "7"))
