...
testthat::test_that("get_call of default EmptyFilterState returns NULL by default", {
  filter_state <- EmptyFilterState$new(NA, slice = filter_conf(dataname = "data", varname = "variable"))
...
testthat::test_that("get_call of default EmptyFilterState returns !is.na() call if keep_na is FALSE", {
  filter_state <- EmptyFilterState$new(NA, slice = filter_conf(dataname = "data", varname = "variable", keep_na = FALSE))
