...
testthat::test_that("constructor accepts a Date object", {
  testthat::expect_no_error(
    DateFilterState$new(dates, slice = filter_conf(dataname = "data", varname = "variable"))
  )
  testthat::expect_error(
    DateFilterState$new(as.POSIXct(dates), slice = filter_conf(dataname = "data", varname = "variable")),
...
testthat::test_that("constructor raises warning when selected out of range", {
  testthat::expect_warning(
    DateFilterState$new(
      dates,
      slice = filter_conf(dataname = "data", varname = "variable", selected = range(dates) + c(-1, 1))
    ),
...
testthat::test_that("constructor raises warning when selected is not sorted", {
  testthat::expect_warning(
    DateFilterState$new(
      dates,
      slice = filter_conf(dataname = "data", varname = "variable", selected = dates[c(10, 1)])
    ),
...
testthat::test_that("constructor raises error when selection is not Date", {
  testthat::expect_error(
    DateFilterState$new(dates, slice = filter_conf(dataname = "data", varname = "variable", selected = c("a", "b"))),
...
testthat::test_that("constructor raises warning when chioces is not sorted", {
  testthat::expect_warning(
    DateFilterState$new(
      dates,
      slice = filter_conf(dataname = "data", varname = "variable", choices = dates[c(10, 1)])
    ),
...
testthat::test_that("constructor raises warning when chioces out of range", {
  testthat::expect_warning(
    DateFilterState$new(
      dates,
      slice = filter_conf(dataname = "data", varname = "variable", choices = range(dates) + c(-1, 1))
    ),
...
testthat::test_that("constructor raises error when selection is not Date", {
  testthat::expect_error(
    DateFilterState$new(dates, slice = filter_conf(dataname = "data", varname = "variable", choices = c("a", "b"))),
    "Must be of class 'Date'"
  )
})

testthat::test_that("constructor sets default state", {
  fs <- DateFilterState$new(dates, slice = filter_conf(dataname = "data", varname = "variable"))
...
testthat::test_that("set_state: selected accepts vector of two coercible to Date elements", {
  filter_state <- DateFilterState$new(dates, slice = filter_conf(dataname = "data", varname = "variable"))
  testthat::expect_no_error(
    filter_state$set_state(filter_conf(selected = dates[c(1, 10)], dataname = "data", varname = "variable"))
  )
  testthat::expect_no_error(
    filter_state$set_state(filter_conf(selected = as.integer(dates[c(1, 10)]), dataname = "data", varname = "variable"))
  )
  testthat::expect_error(
    filter_state$set_state(filter_conf(selected = dates[1], dataname = "data", varname = "variable")),
    "The array of set values must have length two"
  )
  testthat::expect_error(
    filter_state$set_state(filter_conf(selected = c("a", "b"), dataname = "data", varname = "variable")),
    "The array of set values must contain values coercible to Date"
  )
})
...
testthat::test_that("set_state: selected raises warning when selection is not within the possible range", {
  ...
  testthat::expect_warning(
    filter_state$set_state(
      filter_conf(dataname = "data", varname = "variable", choices = dates, selected = c(dates[1] - 1, dates[10]))
    ),
    "outside of the possible range"
  )
  testthat::expect_warning(
    filter_state$set_state(
      filter_conf(dataname = "data", varname = "variable", choices = dates, selected = c(dates[1], dates[10] + 1))
    ),
    "outside of the possible range"
  )
  testthat::expect_warning(
    filter_state$set_state(
      filter_conf(dataname = "data", varname = "variable", choices = dates, selected = c(dates[1] - 1, dates[10] + 1))
    ),
    "outside of the possible range"
  )
})
...
testthat::test_that("set_state: selected range is limited to lower and upper bound of possible range", {
  ...
  suppressWarnings(filter_state$set_state(
    filter_conf(dataname = "data", varname = "variable", selected = c(dates[1] - 1, dates[10]))
  ))
  testthat::expect_equal(shiny::isolate(filter_state$get_state()$selected), c(dates[1], dates[10]))
  suppressWarnings(filter_state$set_state(
    filter_conf(dataname = "data", varname = "variable", selected = c(dates[1], dates[10] + 1))
  ))
  testthat::expect_equal(shiny::isolate(filter_state$get_state()$selected), c(dates[1], dates[10]))
  suppressWarnings(filter_state$set_state(
    filter_conf(dataname = "data", varname = "variable", selected = c(dates[1] - 1, dates[10] + 1))
  ))
  testthat::expect_equal(shiny::isolate(filter_state$get_state()$selected), c(dates[1], dates[10]))
})
...
testthat::test_that("set_state: selected raises error when selection is not a Date or coercible", {
  filter_state <- DateFilterState$new(dates, slice = filter_conf(dataname = "data", varname = "variable"))
  testthat::expect_error(
    filter_state$set_state(filter_conf(dataname = "data", varname = "variable", selected = c("a", "b"))),
    "The array of set values must contain values coercible to Date"
  )
})
...
testthat::test_that("method get_call of default DateFilterState object returns NULL", {
  filter_state <- DateFilterState$new(dates, slice = filter_conf(dataname = "data", varname = "dates"))
...
testthat::test_that("get_call returns call selected different than choices", {
  filter_state <- DateFilterState$new(
    dates,
    slice = filter_conf(dataname = "data", varname = "variable", selected = dates[c(1, 3)])
  )
...
testthat::test_that("get_call returns call always if choices are limited - regardless of selected", {
  filter_state <- DateFilterState$new(
    x = dates,
    slice = filter_conf(dataname = "data", varname = "variable", choices = dates[c(1, 3)], selected = dates[c(1, 3)])
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
    quote(variable >= as.Date("2000-01-01") & variable <= as.Date("2000-01-03"))
...
testthat::test_that("get_call adds is.na(variable) to returned call if keep_na is true", {
  filter_state <- DateFilterState$new(
    x = c(dates, NA),
    slice = filter_conf(dataname = "data", varname = "variable", selected = dates[c(1, 3)], keep_na = TRUE)
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
...
testthat::test_that("get_call returns call if all selected but NA exists", {
  filter_state <- DateFilterState$new(
    x = c(dates, NA),
    slice = filter_conf(dataname = "data", varname = "variable", keep_na = FALSE)
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
