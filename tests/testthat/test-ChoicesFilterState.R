...
testthat::test_that("constructor raises warning if choices out of range", {
  testthat::expect_warning(
    ChoicesFilterState$new(
      chars,
      slice = filter_var(dataname = "data", varname = "variable", choices = c(chars, "item4"))
    ),
...
testthat::test_that("constructor raises warning if choices out of range", {
  testthat::expect_warning(
    ChoicesFilterState$new(
      chars,
      slice = filter_var(dataname = "data", varname = "variable", choices = "item4")
    ),
    "Some of the choices not within variable values, adjusting"
  )
  testthat::expect_warning(
...
testthat::test_that("constructor raises warning if selected out of range", {
  testthat::expect_warning(
    ChoicesFilterState$new(
      chars,
      slice = filter_var(dataname = "data", varname = "variable", selected = c(chars, "item4"))
    ),
    "not in choices"
  )
  testthat::expect_warning(
    ChoicesFilterState$new(
      chars,
      slice = filter_var(dataname = "data", varname = "variable", selected = "item4")
    ),
    "not in choices"
  )
})
...
testthat::test_that("method get_call of default ChoicesFilterState object returns NULL", {
  filter_state <- ChoicesFilterState$new(letters, slice = filter_var(dataname = "data", varname = "variable"))
...
testthat::test_that("get_call returns NULL if all choices are selected", {
  filter_state <- ChoicesFilterState$new(
    letters,
    slice = filter_var(dataname = "data", varname = "variable", selected = letters)
  )
  testthat::expect_null(shiny::isolate(filter_state$get_call()))
})
...
testthat::test_that("get_call returns call selected different than choices", {
  filter_state <- ChoicesFilterState$new(
    letters,
    slice = filter_var(dataname = "data", varname = "variable", selected = letters[1:3])
  )
  testthat::expect_identical(
...
testthat::test_that("get_call returns call always if choices are limited - regardless of selected", {
  filter_state <- ChoicesFilterState$new(
    letters,
    slice = filter_var(
      dataname = "data", varname = "variable", choices = letters[1:3], selected = letters[1:3]
    )
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
...
testthat::test_that("get_call prefixes varname by dataname$varname if extract_type='list'", {
  filter_state <- ChoicesFilterState$new(
    letters,
    slice = filter_var(dataname = "data", varname = "variable", selected = letters[1:3]), extract_type = "list"
  )
...
testthat::test_that("get_call uses `==` comparison when single value selected", {
  filter_state <- ChoicesFilterState$new(
    chars,
    slice = filter_var(dataname = "data", varname = "variable", selected = chars[1])
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
...
testthat::test_that("get_call adds is.na(variable) to returned call if keep_na is true", {
  filter_state <- ChoicesFilterState$new(
    x = c(chars, NA),
    slice = filter_var(dataname = "data", varname = "variable", selected = chars[1:2], keep_na = TRUE)
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
...
testthat::test_that("get_call returns calls appropriate for factor variable", {
  filter_state <- ChoicesFilterState$new(
    x = facts,
    slice = filter_var(dataname = "data", varname = "variable", selected = facts[1])
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
    quote(variable == "item1")
...
testthat::test_that("get_call returns calls appropriate for numeric variable", {
  filter_state <- ChoicesFilterState$new(
    nums,
    slice = filter_var(dataname = "data", varname = "variable", selected = nums[1])
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
    quote(variable == 1)
...
testthat::test_that("get_call returns calls appropriate for date variable", {
  filter_state <- ChoicesFilterState$new(
    x = dates,
    slice = filter_var(dataname = "data", varname = "variable", selected = dates[1])
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
...
testthat::test_that("get_call returns calls appropriate for posixct variable", {
  filter_state <- ChoicesFilterState$new(
    x = posixct,
    slice = filter_var(dataname = "data", varname = "variable", selected = posixct[1])
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
...
testthat::test_that("get_call returns calls appropriate for posixlt variable", {
  filter_state <- ChoicesFilterState$new(
    x = posixlt,
    slice = filter_var(dataname = "data", varname = "variable", selected = posixlt[1])
  )
  testthat::expect_identical(
    shiny::isolate(filter_state$get_call()),
...
testthat::test_that("set_state raises warning when selection not within allowed choices", {
  filter_state <- ChoicesFilterState$new(x = chars, slice = filter_var(dataname = "data", varname = "variable"))
  testthat::expect_warning(
  ...
  filter_state <- ChoicesFilterState$new(facts, slice = filter_var(dataname = "data", varname = "variable"))
  testthat::expect_warning(
    filter_state$set_state(filter_var(dataname = "data", varname = "variable", selected = "item4")),
    "not in choices"
  )
  ...
  filter_state <- ChoicesFilterState$new(nums, slice = filter_var(dataname = "data", varname = "variable"))
  testthat::expect_warning(
  ...
  filter_state <- ChoicesFilterState$new(dates, slice = filter_var(dataname = "data", varname = "variable"))
  testthat::expect_warning(
  ...
  filter_state <- ChoicesFilterState$new(posixct, slice = filter_var(dataname = "data", varname = "variable"))
  testthat::expect_warning(
...
testthat::test_that("set_state sets intersection of choices and passed values", {
  filter_state <- ChoicesFilterState$new(chars, slice = filter_var(dataname = "data", varname = "variable"))
  suppressWarnings(
    shiny::isolate(
      filter_state$set_state(filter_var(dataname = "data", varname = "variable", selected = c("item1", "item4")))
    )
  ...
  filter_state <- ChoicesFilterState$new(posixlt, slice = filter_var(dataname = "data", varname = "variable"))
  testthat::expect_warning(
    shiny::isolate(
      filter_state$set_state(
...
testthat::test_that("set_state sets multiple option", {
  filter_state <- ChoicesFilterState$new(
    x = chars,
    slice = filter_var(dataname = "data", varname = "variable", multiple = TRUE)
  )
...
testthat::test_that("format accepts logical show_all", {
  filter_state <- ChoicesFilterState$new(7, slice = filter_var(dataname = "data", varname = "variable"))
