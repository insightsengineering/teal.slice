...
#' ui <- fluidPage(
#'   useShinyjs(),
#'   column(4,isolate(filter_state$ui("fs"))),
#'   column(4, div(
...
#'   ),
#'   column(4, div(
#'     actionButton("button1", "set selected"), br(),
#'     actionButton("button2", "set filter state"), br(),
#'     actionButton("button3", "set keep NA"), br(),
#'     actionButton("button4", "set drop NA"), br(),
#'     actionButton("button5", "deselect all"), br()
#'   )
#'   )
#' )
#'
