...
#'   column(5, div(
#'     h4("Add some filters"),
#'     filter_states$ui_add_filter_state("add_filters", x),
...
#'   )),
#'   column(4, div(
#'     actionButton("button1", "set SEX == \"F\""), br(),
#'     actionButton("button2", "set AGE < 30"), br(),
#'     actionButton("button3", "remove SEX"), br(),
#'     actionButton("button4", "clear all filters"), br()
#'   ))
#' )
#'
