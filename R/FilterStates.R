...
FilterStates <- R6::R6Class( # nolint
  ...
  public = list(
    ...
    #' situation when call is using some slots of the original data, for example `dataname[[slot]]`.
    #' By default `dataname_prefixed = dataname` and it's not customizable through class methods.
