...
#> is.na(x) | x >= as.POSIXct("2025-12-02 01:25:08", tz = "Etc/UTC") & 
#>     x < as.POSIXct("2025-12-02 10:25:09", tz = "Etc/UTC")
...
isolate(filter_state$get_call())
#> is.na(x) | x >= as.POSIXct("2025-12-02 01:25:11.324013", tz = "Etc/UTC") & 
#>     x < as.POSIXct("2025-12-02 01:25:17.324055", tz = "Etc/UTC")
