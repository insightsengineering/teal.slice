...
set_filter_state(
  ...
  filter = filter_settings(
    filter_conf(dataname = "iris", varname = "Species", selected = "virginica", keep_na = FALSE),
    filter_conf(dataname = "mtcars", varname = "mpg", selected = c(20.0, 25.0), keep_na = FALSE, keep_inf = FALSE),
...
set_filter_state(
  datasets = datasets,
  filter = filter_settings(
    filter_conf(dataname = "mtcars", varname = "mpg", selected = c(22.0, 25.0))
  )
)
```
