...
This vignette is provides a deep dive into the design of the `teal.slice` package.
It is intended for advanced developers.
If you want to merely use `teal.slice`, the *Filter panel for developers* vignette, it should satisfy all your needs.


## Introduction

The `teal.slice` package is composed of of multiple classes, whose primary purpose is to provide a `shiny` module for managing and displaying filters.
The highest class in the structure is `FilteredData`.
